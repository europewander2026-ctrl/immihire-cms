...
import SpotlightCinema from './SpotlightCinema';
import EligibilityPulse from './EligibilityPulse';
...
const ServiceCatalog = ({
  ...
  subtitle = 'Comprehensive immigration solutions tailored to your unique profile. Explore our specialized services designed to make your global dreams a reality.',
      ...
      <section className="pt-48 pb-20 bg-white text-center">
        <div className="container mx-auto px-6 reveal active">
          ...
          <h1 className="font-heading font-bold text-5xl md:text-7xl text-darkBlue mb-6">
            {title} <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-400">{titleHighlight}</span>
          </h1>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 max-w-3xl">
          ...
          <div className="space-y-4">
            {(faqData || defaultFaqData).map((faq, index) => (
